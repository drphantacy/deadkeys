...
export const initializeWordLibrary = () => {
    const cryptoWords = [
        'linera', 'microchains', 'cross-chain message', 'faucet', 'bytecode', 'quorum', 'epoch', 'account', 'validator', 'webassembly', 'single-owner chain', 'mathieu baudet', 'james kay', 'wilt0n', 'zhao kk', 'hasto', 'afck', 'dannygreene', 'lpaydat', 'bitcoin', 'ethereum', 'blockchain', 'wallet', 'mining', 'token', 'altcoin', 'ledger', 'hash', 'smart contract', 
